export const interestsSection = [
  ...
  },
  {
    ...
    questions: [
      ...
      {
        questionId: "4_4",
        question: "Leading and motivating teams or groups toward a common goal",
        type: 1,
      },
      {
        questionId: "4_5",
    ...
    questions: [
      {
        questionId: "5_1",
        question:
          "Designing or building something from scratch, like a piece of furniture or a website",
        type: 1,
      },
      {
        questionId: "5_2",
      ...
      },
      {
        questionId: "5_3",
        question:
          "Engaging in a deep conversation or debate with friends or colleagues",
        type: 1,
      },
      {
        questionId: "5_4",
    ...
    questions: [
      {
        questionId: "6_1",
        question:
          "I prefer working independently because I can set my own pace and focus without distractions.",
        type: 1,
      },
      {
        questionId: "6_2",
      ...
      },
      {
        questionId: "6_3",
        question:
          "I thrive in large team environments where there's diversity of thought and ample opportunity for brainstorming.",
        type: 1,
      },
      {
        questionId: "6_4",
  ...
  },
  {
    ...
    questions: [
      ...
      },
      {
        questionId: "7_3",
        question:
          "A dynamic and fast-paced environment where things are constantly changing",
        type: 1,
      },
      {
        questionId: "7_4",
    ...
    questions: [
      {
        questionId: "8_1",
        question:
          " Interacting with customers, clients, or stakeholders and providing excellent service",
        type: 1,
      },
      {
        questionId: "8_2",
      ...
      },
      {
        questionId: "8_3",
        question:
          "Learning new skills or technologies and applying them to real-world situations",
        type: 1,
      },
      {
        questionId: "8_4",
    ...
    questions: [
      {
        questionId: "9_1",
        question:
          "Elon Musk, for his innovation and entrepreneurial spirit in multiple industries",
        type: 1,
      },
      {
        questionId: "9_2",
      ...
      },
      {
        questionId: "9_3",
        question:
          "Stephen Hawking, for his groundbreaking contributions to theoretical physics and cosmology",
        type: 1,
      },
      {
        questionId: "9_4",
    ...
    questions: [
      {
        questionId: "10_1",
        question:
          "Pursuing a passion project or hobby full-time, such as writing, painting, or starting a nonprofit",
        type: 1,
      },
      {
        questionId: "10_2",
      ...
      },
      {
        questionId: "10_3",
        question:
          "Investing in further education or personal development to continuously learn and grow",
        type: 1,
      },
      {
        questionId: "10_4",
